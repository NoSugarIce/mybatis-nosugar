 ...
 * @date 2020/12/19
 */
public interface PropertyToColumn extends ConvertToColumn<String> {

    @Override
    default String toColumn(String property, Class<?> entityClass) {
        return EntityMetadataRegistry.Holder.getInstance().getColumnByProperty(entityClass, property);
    }
}
