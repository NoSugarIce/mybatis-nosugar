 ...
 * @date 2020/12/19
 */
public class In<T> extends ListValueCriterion<T, In<T>> {

    private static final long serialVersionUID = 323715147859472948L;

    public In(String column) {
    ...
    public In(String column, T[] values, Separator separator) {
        this(column, Arrays.asList(values), separator);
    }
