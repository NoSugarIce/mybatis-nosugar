...
public class MapperStatementBuilder {
    ...
    protected SqlScriptBuilder sqlScriptBuilder;
    protected MapperBuilderAssistant assistant;

    public MapperStatementBuilder withMapperInterface(Class<?> mapperInterface) {
        this.mapperClass = mapperInterface;
        return this;
    }

    public MapperStatementBuilder withMetadataBuildingContext(MetadataBuildingContext buildingContext) {
        this.buildingContext = buildingContext;
        return this;
    }

    public MapperStatementBuilder build() {
    ...
    protected SqlSource createSqlSource(Configuration configuration, Method method, String script, Class<?> parameterType
        ...
        if (script == null) {
            return sqlScriptBuilder.buildSqlSource(method, sqlCommandType);
        }
