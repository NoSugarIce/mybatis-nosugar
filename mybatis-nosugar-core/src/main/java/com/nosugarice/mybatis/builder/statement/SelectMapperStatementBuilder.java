...
import com.nosugarice.mybatis.mapper.select.SelectByCriteriaMapper;
 ...
 * @date 2020/12/2
 */
public class SelectMapperStatementBuilder extends BaseMapperStatementBuilder {

    protected SelectMapperStatementBuilder(SqlScriptBuilder sqlScriptBuilder, MapperBuilderAssistant assistant) {
        super(sqlScriptBuilder, assistant);
    }

    @Override
    public Collection<Class<? extends Mapper>> getMapperTypes() {
        return Arrays.asList(SelectByPrimaryKeyMapper.class, SelectByCriteriaMapper.class);
    }
