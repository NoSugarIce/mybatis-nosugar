package com.nosugarice.mybatis.builder.query;
...
public enum ConditionType {
    ...
    private final Class<? extends PropertyCriterion<?>> propertyCriterionTye;

    <T extends PropertyCriterion<?>> ConditionType(ValueType valueType, String[] keywords, Class<T> propertyCriterionClass) {
    ...
    public Class<? extends PropertyCriterion<?>> getPropertyCriterionTye() {
