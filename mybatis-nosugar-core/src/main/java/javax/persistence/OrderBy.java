 ...
 *
 * <p> The <code>OrderBy1</code> annotation may be applied to an element
 * collection. When <code>OrderBy1</code> is applied to an element collection of
 ...
 * the ordering.
 *
 * <p> The <code>OrderBy1</code> annotation is not used when an order
 * column is specified.
 *
 *
 * <pre>
 ...
 *       &#064;OrderBy1 // ordering by primary key is assumed
 ...
 *         ...
 *       &#064;ElementCollection
 *       &#064;OrderBy1("zipcode.zip, zipcode.plusFour")
